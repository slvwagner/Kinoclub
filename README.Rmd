...
* [4 Datensätze](#A_4_Datensätze)
    + [4.1 Advance-Tickets](#A_4.1_Advance-Tickets)
        ...
        + [4.1.4 Gutscheine und Abos](#A_4.1.4_Gutscheine und Abos)
            + [4.1.4.1 Abos](#A_4.1.4.1_Abos)
            + [4.1.4.2 Förderer](#A_4.1.4.2_Förderer)
            + [4.1.4.3 Gutschein](#A_4.1.4.3_Gutschein)
    + [4.2 Excel Dateien](#A_4.2_Excel Dateien)
        ...
        + [4.2.5 WordPress Filmvorschläge auswerten](#A_4.2.5_WordPress Filmvorschläge auswerten)
...
* [7 Berichte](#A_7_Berichte)
    + [7.1 Abrechnung Filmvorführung](#A_7.1_Abrechnung Filmvorführung)
        + [7.1.1 Berechnung der prozentuallen Abgaben](#A_7.1.1_Berechnung der prozentuallen Abgaben)
        + [7.1.2 Berechnung der Fixen Abgaben](#A_7.1.2_Berechnung der Fixen Abgaben)
...
#### 4.1.4 Gutscheine und Abos<a name="A_4.1.4_Gutscheine und Abos"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)

##### 4.1.4.1 Abos<a name="A_4.1.4.1_Abos"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
##### 4.1.4.2 Förderer<a name="A_4.1.4.2_Förderer"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
##### 4.1.4.3 Gutschein<a name="A_4.1.4.3_Gutschein"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
#### 4.2.5 WordPress Filmvorschläge auswerten<a name="A_4.2.5_WordPress Filmvorschläge auswerten"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
#### 7.1.1 Berechnung der prozentuallen Abgaben<a name="A_7.1.1_Berechnung der prozentuallen Abgaben"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
...
#### 7.1.2 Berechnung der Fixen Abgaben<a name="A_7.1.2_Berechnung der Fixen Abgaben"></a>
[Inhaltsverzeichnis](#Inhaltsverzeichnis)
