...
Copy paste von html für jede Vorführung und bitte speichern unter "input/advance tickets/Eintritt xxxx.xxx xx.xx.xx.txt" Es muss die Kalenderwoche sowie der Film ausgewählt werden.\
![Eintritt](doc/picts/eintritt.png) \
Alles mit "ctrl a" markieren und kopieren "crtl c" und entsprechend abspeichern("input/advance tickets/Eintritt xxxx.xxx xx.xx.xx.txt").

#### Kiosk
**Kiosk Suisanummer Datum.txt**  \
Copy paste von html für jede Vorführung und Speichern unter "input/advance tickets/Kiosk xxxx.xxx xx.xx.xx.txt".\
...
Die Datei **"user_settings.R"** enthält am Anfang die folgenden Definition die abgeändert werden können um das Verhalten des Scripts zu beeinflussen.
