...
##### Abos
**"atelierkino_abo.txt"**
Copy paste von html für die gewünschte Abrechnungsperiode. Bitte speichern unter "input/advance tickets/atelierkino_abo.txt"\
...
Copy paste von html für die gewünschte Abrechnungsperiode. Bitte speichern unter "input/advance tickets/atelierkino_foerderer.txt"\
Im Menu auf "Abos" <https://www.advance-ticket.ch/abos?lang=de> navigieren.\
Abo typ wählen: **atelierkino/abo** \ und den Button suchen wählen. \
Nun können die Daten exportiert werden. Bitte speichern unter .../Kinoklub/Input/advance tickets \
...
Copy paste von html für die gewünschte Abrechnungsperiode. Bitte speichern unter "input/advance tickets/atelierkino_gutschein.txt"\
Im Menu auf "Abos" <https://www.advance-ticket.ch/abos?lang=de> navigieren.\
Abo typ wählen: **atelierkino/abo** \ und den Button suchen wählen. \
Nun können die Daten exportiert werden. Bitte speichern unter .../Kinoklub/Input/advance tickets \
