...
df_temp <- df_Abrechnung|>
 ...
 mutate(Datum_display = paste0(lubridate::day(Datum),".", lubridate::month(Datum),".", lubridate::year(Datum)),
  ...
  select(Datum,Datum_display,Filmtitel, `Verleiherabzug [CHF]`)
```
...
df_temp <- df_Abrechnung|>
 ...
 mutate(Datum_display = paste0(lubridate::day(Datum),".", lubridate::month(Datum),".", lubridate::year(Datum)),
  ...
  select(Datum, Datum_display,Filmtitel,`Sonstige Kosten [CHF]`)
```
...
df_temp <- df_Abrechnung|>
 ...
 mutate(Datum_display = paste0(lubridate::day(Datum),".", lubridate::month(Datum),".", lubridate::year(Datum)),
  ...
  select(Datum, Datum_display, Filmtitel, `MWST [CHF]`)
```
...
df_temp <- df_Abrechnung|>
  reframe(`Umsatz` = sum(`Umsatz [CHF]`, na.rm = T),
          ...
          `Nebenkosten` = -sum(`Sonstige Kosten [CHF]`, na.rm = T),
          `Verleiherabzug` = -sum(`Verleiherabzug [CHF]`, na.rm = T),
          `MWST` = -sum(`MWST [CHF]`, na.rm = T)
          )|>
  as.matrix()|>
  t()
